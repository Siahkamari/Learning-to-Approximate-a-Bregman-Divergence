function bregman_div = MetricLearningAutotuneKnn(metric_learn_alg, y, X, params); 
...
for i=1:length(gammas)
    ...
    accs(i) = cross_validate_knn(y, X, @(y,X) MetricLearning(metric_learn_alg, y, X, A0, params), 2, params.k);
end
